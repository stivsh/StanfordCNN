"""
Perform tests on SVMMultiClassClassifier classifier
"""
import unittest
...
from commonftests import numerical_dj, compare_analitic_and_numerical_dj,\
    simple_optimizer
from mymcsvm import j, h, dj, SVMMultiClassClassifier
...
class TestSVMMultiClassClassifier(unittest.TestCase):
    ...
    def test_gradient(self):
        ...
        self.assertTrue(gradient_error < 10**-5)
    ...
    def test_classification(self):
        ...
        clf = SVMMultiClassClassifier(alpha=0.001, optimizer=simple_optimizer).fit(
